...
<div class="panel panel-default">
 <div class="panel-heading"><h2>Add New Reception Hall</h2></div>
    <div class="panel-body">

  
  <form class="form-horizontal" action="new.php" method="post">
    <div class="form-group row col-sm-10">
      <label class="control-label col-sm-2" for="fn">Hall ID:</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" id="fn" name="fn" data-validation="required">
      </div>
      
    <div class="form-group">
      <label class="control-label col-sm-2" for="fn2">Hall Type:</label>
      <div class="col-sm-3">
        
      <select class="form-control" id="type">
      	<option>---Select one---</option>
        <option>Normal</option>
        <option>Laxuary</option>
    ...
    <div>
        <div class="form-group row col-sm-10">
      <label class="control-label col-sm-2" for="ln">Hall Name:</label>
      <div class="col-sm-8">
