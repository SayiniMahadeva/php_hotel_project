 ...
 <div class="panel-heading"><h2>Create an account</h2></div>
  ...
  <form class="form-horizontal" action="new.php" method="post">
    <div class="form-group row col-sm-10">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" id="lna" name="ln" data-validation="required">
      </div>
    </div>
    <div>
        <div class="form-group row col-sm-10">
    ...
    <div class="form-group row col-sm-10">
      ...
      <div class="col-sm-8">          
        <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="pwd" data-validation="length" data-validation-length="min8">
      </div>
      </div>
          <div class="form-group row col-sm-10">
      <label class="control-label col-sm-2" for="pwd">Confirm your Password:</label>
      <div class="col-sm-8">          
        <input type="password" class="form-control" id="pwd" placeholder="Reenter password" name="conp"  data-validation="confirmation">
      </div></div>
       <div class="form-group row col-sm-10">
      <label class="control-label col-sm-2" for="fn">Contact No:</label>
      <div class="col-sm-8">
        <input type="..." class="form-control" id="mobile-num" name="cn" >
      </div></div>
      <div class="form-group row col-sm-10">
    ...
    <div class="form-group row col-sm-10">        
      ...
      <a href="reservation.php" class="btn btn-primary" role="button">Register</a>
